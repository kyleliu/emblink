...
#ifndef CEF_LIBCEF_RENDERER_PLUGINS_POWER_SAVER_INFO_H_
#define CEF_LIBCEF_RENDERER_PLUGINS_POWER_SAVER_INFO_H_
...
#endif  // CEF_LIBCEF_RENDERER_PLUGINS_POWER_SAVER_INFO_H_
